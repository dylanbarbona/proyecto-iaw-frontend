...
import { CreatePostInput, SearchPostInput, UpdatePostInput } from '../interfaces/post.interface';

@Injectable({
  providedIn: 'root'
})
export class PostService {
  private readonly POST_URL = '/post'
  ...
  delete({ _id }: SearchPostInput): Observable<Post> {
    return this.http.delete<Post>(environment.HOST + this.POST_URL + '/' + _id, { withCredentials: true })
  }
